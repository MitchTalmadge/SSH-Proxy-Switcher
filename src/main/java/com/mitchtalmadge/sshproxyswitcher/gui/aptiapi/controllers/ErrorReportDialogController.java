...
import com.mitchtalmadge.sshproxyswitcher.gui.aptiapi.ErrorReportDetailsDialog;
...
public class ErrorReportDialogController {
    ...
    private void populateReport(boolean logAttached)
    {
        ...
        if (logAttached) {
            errorReport.setLogFile(SSHProxySwitcher.getInstance().getLoggingManager().getLogFile());
        }
    }
