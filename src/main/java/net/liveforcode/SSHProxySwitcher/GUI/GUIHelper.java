...
public class GUIHelper {
    ...
    public void showWarningDialog(String title, String header, String message) {
    ...
    public boolean getConfirmationFromDialog(String title, String header, String message) {
